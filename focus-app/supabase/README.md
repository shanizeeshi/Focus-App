...
1. Open [Supabase Dashboard](https://supabase.com/dashboard) → your **Focus App** project.
2. Go to **SQL Editor** → **New query**.
3. Copy the contents of `schema.sql` (in this folder) and paste into the editor.
